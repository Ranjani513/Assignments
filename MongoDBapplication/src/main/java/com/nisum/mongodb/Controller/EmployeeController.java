package com.nisum.mongodb.Controller;

import com.nisum.mongodb.model.Employee;
import com.nisum.mongodb.model.EmployeeEvent;
...
public class EmployeeController {
    ...
    final String empId) 
    {
        return employeeRepository.findById(empId) .flatMapMany(employee -> { Flux<Long> interval = Flux.interval(Duration.ofSeconds(2));
